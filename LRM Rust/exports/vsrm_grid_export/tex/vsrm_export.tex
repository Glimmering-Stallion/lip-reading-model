...
\node[canvas is zy plane at x=0, transform shape, inner sep=0pt] (inputstrip0) at (-3,0,0) {\includegraphics[width=9.000cm,height=4.400cm]{input_bundle/000.png}};

\node[canvas is zy plane at x=0, transform shape, inner sep=0pt] (inputstrip1) at (-2.25,0,0) {\includegraphics[width=9.000cm,height=4.400cm]{input_bundle/001.png}};

\node[canvas is zy plane at x=0, transform shape, inner sep=0pt] (inputstrip2) at (-1.5,0,0) {\includegraphics[width=9.000cm,height=4.400cm]{input_bundle/002.png}};

\node[canvas is zy plane at x=0, transform shape, inner sep=0pt] (inputstrip3) at (-0.75,0,0) {\includegraphics[width=9.000cm,height=4.400cm]{input_bundle/003.png}};
